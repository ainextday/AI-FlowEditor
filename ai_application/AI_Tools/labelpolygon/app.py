...
from ai_application.AI_Tools.labelpolygon import __appname__
from ai_application.AI_Tools.labelpolygon import PY2

from . import utils
from ai_application.AI_Tools.labelpolygon.config import get_config
from ai_application.AI_Tools.labelpolygon.label_file import LabelFile
from ai_application.AI_Tools.labelpolygon.label_file import LabelFileError
from ai_application.AI_Tools.labelpolygon.logger import logger
from ai_application.AI_Tools.labelpolygon.shape import Shape
from ai_application.AI_Tools.labelpolygon.widgets import BrightnessContrastDialog
from ai_application.AI_Tools.labelpolygon.widgets import Canvas
from ai_application.AI_Tools.labelpolygon.widgets import FileDialogPreview
from ai_application.AI_Tools.labelpolygon.widgets import LabelDialog
from ai_application.AI_Tools.labelpolygon.widgets import LabelListWidget
from ai_application.AI_Tools.labelpolygon.widgets import LabelListWidgetItem
from ai_application.AI_Tools.labelpolygon.widgets import ToolBar
from ai_application.AI_Tools.labelpolygon.widgets import UniqueLabelQListWidget
from ai_application.AI_Tools.labelpolygon.widgets import ZoomWidget
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def openPrevImg(self, _value=False):
        ...
        self.update_save_file(self.filename)
    ...
    # =====================================================================
    # New Update
    def update_save_file(self, filename):
        # print('file name :', filename)

        json_file = filename[:-4] + '.json'
        # print("json_file :", json_file)
        # Image_2023_03_15_100553_5
        ...
        if os.path.isfile(json_file):
            try:
                ...
                # print("save_location_path :", save_location_path)
                Yolo_Data = ""
                list_load_labelname, Exiting_file = self.Classes(save_location_path + "classes.txt")

                print("Exiting_file :", Exiting_file)
                print("list_load_labelname :", list_load_labelname)
                ...
                if not os.path.isfile(filename[:-3] + "txt"):
                    for j in range(len(shapes)):
                        if len(list_load_labelname) > 0:
                            ...
                            #     if str(shapes[j]['label']) not in list_load_labelname:
                            #         list_load_labelname.append(str(shapes[j]['label']))

                            # print("str(shapes[j]['label']) :", str(shapes[j]['label']))
                            ...
                            # print("Start Class Yolo_Data:", Yolo_Data)
                            # print()

                        else:
                            if j == 0:
                                # print("1st Label:", str(shapes[0]['label']))
                                number_of_label.append(str(shapes[0]['label']))
                                # print("1st number_of_label: ", number_of_label)
                            
                            else:
                                if str(shapes[j]['label']) not in number_of_label:
                                    number_of_label.append(str(shapes[j]['label']))
                            
                                else:
                                    number_of_label = list(set(number_of_label))
                                    # print("number_of_lable :", number_of_label)

                            Yolo_Data = str(number_of_label.index(str(shapes[j]['label']))) + " "
                        ...
                        # print("Yolo_Data List ", j, " :", Yolo_Data)
                    ...
                    # else:
                    #     # for yolo_txt in YoloDataDict:
                    #     #     NewYolo_String = NewYolo_String + str(YoloDataDict[str(yolo_txt)])

                    #     NewYolo_String = Yolo_Data
                ...
                if os.path.isfile(save_location_path + "classes.txt"):
                    ...
                    label_name = ""
                    for k in range(len(number_of_label)):
                        label_name = label_name + str(number_of_label[k]) + "\n"
