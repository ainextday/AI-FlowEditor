...
import sys
import locale
from ai_application.AI_Tools.libs.ustr import ustr
...
class StringBundle:
    ...
    def __init__(self, create_key, localeStr):
        ...
        self.idToMessage = {'masterLabling': 'Master Labeling','aimMode': 'AimMode','fileListTxt': 'Master Lists','filesTxt': 'Master List'}
